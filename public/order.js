...
const T = {
  sq: {
    ...
    seeOrder: "Shiko",
    payNote: "Paguhet me dorëzim, në dorë. Numri i porosisë thuhet kur vjen sjellësi.",
  ...
  mk: {
    ...
    pausedTitle: "Кујната запре со порачки",
    pausedBody: "Моментно има многу работа. Обиди се повторно подоцна.",
    ...
    qrHint: "Работиш во фирма со QR код на ѕид? Скенирај го и адресата доаѓа сама.",
    ...
    gone: "Нешто снема во меѓувреме. Освежи ја страната.",
